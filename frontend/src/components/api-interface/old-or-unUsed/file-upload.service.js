let FileUploadServiceInjectables = ['host', 'endPoints', '$http', '$location', '$q', 'CreatorDataFactory', 'ListorDataFactory', 'UtilFactory'];
...
FileUploadService.$inject = FileUploadServiceInjectables;