export default class ViewPdfController {
    constructor($location, $sce, store, UtilFactory) {
        'ngInject';
    ...
    $onInit() {
        ...
        this.userFileName = profile.name ? profile.name.replace(/\s/, '_') : 'resume';
...
ViewPdfController.$inject = ['$location', '$sce', 'store', 'UtilFactory'];