...
(function (root, factory) {
    ...
    function _initializeZoom() {
        ...
        console.log(parent);
       // parent.insertBefore(self.element, wrap);
       // self.element.appendChild(wrap);
       // wrap.appendChild(zoomer);
        self.element.prepend(wrap);
        wrap.appendChild(zoomer);
    ...
    function _bindPoints(points) {
        if (points.length != 4) {
            throw "Croppie2 - Invalid number of points supplied: " + points;
        }
        var self = this,
    ...
    function _rotate(deg) {
        if (!this.options.useCanvas) {
            throw 'Croppie2: Cannot rotate without enableOrientation';
        }
            ...
            if (ot === 'string') {
                ...
                return this.each(function () {
                    ...
                    if ($.isFunction(method)) {
                        ...
                        throw 'Croppie2 ' + opts + ' method not found';
                    }
                });
            }
            else {
    ...
    function Croppie2(element, opts) {
        ...
        this.options = deepExtend(deepExtend({}, Croppie2.defaults), opts);
    ...
    exports.Croppie2 = window.Croppie2 = Croppie2;

    if (typeof module === 'object' && !!module.exports) {
        module.exports = Croppie2;
    }
}));
